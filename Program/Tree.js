class Tree {
	constructor(data) {
        this.object = new WorldObject({ type: "Tree", subtype: "Basic", baseObject: this });
	...
	generateContent() {
		...
		this.object.addToMeshCollection(this.trunk);
		...
		this.object.addToMeshCollection(this.tree);

		return this.object.meshCollection;
	}
};