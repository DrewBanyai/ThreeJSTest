class Bed {
	...
	generateContent() {
        ...
        bedPostTL.position.set(bedPosition.x - (plotSize.x / 2) + (bedPostSize.x / 2), bedPosition.y + (plotSize.y / 2) + (bedPostSize.y / 2), bedPosition.z - (plotSize.z / 2) + (bedPostSize.z / 2));
        ...
        bedPostTR.position.set(bedPosition.x + (plotSize.x / 2) - (bedPostSize.x / 2), bedPosition.y + (plotSize.y / 2) + (bedPostSize.y / 2), bedPosition.z - (plotSize.z / 2) + (bedPostSize.z / 2));
        ...
        bedPostBL.position.set(bedPosition.x - (plotSize.x / 2) + (bedPostSize.x / 2), bedPosition.y + (plotSize.y / 2) + (bedPostSize.y / 2), bedPosition.z + plotSize.z + (plotSize.z / 2) - (bedPostSize.z / 2));
        ...
        bedPostBR.position.set(bedPosition.x + (plotSize.x / 2) - (bedPostSize.x / 2), bedPosition.y + (plotSize.y / 2) + (bedPostSize.y / 2), bedPosition.z + plotSize.z + (plotSize.z / 2) - (bedPostSize.z / 2));
        ...
        bedFrame.position.set(bedPosition.x, bedPosition.y + (plotSize.y / 2) + bedPostSize.y + (bedFrameSize.y / 2), bedPosition.z + (plotSize.z / 2));
        ...
        bedMattress.position.set(bedPosition.x, bedPosition.y + (plotSize.y / 2) + bedPostSize.y + bedFrameSize.y + (mattressSize.y / 2), bedPosition.z + (plotSize.z / 2));
        ...
        bedPillow.position.set(bedPosition.x, bedPosition.y + (plotSize.y / 2) + bedPostSize.y + bedFrameSize.y + mattressSize.y + (pillowSize.y / 2), bedPosition.z - (pillowSize.z / 2));
